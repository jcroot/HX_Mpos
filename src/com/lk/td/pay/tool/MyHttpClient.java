...
import com.lk.td.pay.utils.DeviceUtils;
import com.lk.td.pay.utils.JUtil;
...
public class MyHttpClient {
    ...
    private MyHttpClient() {
        version = Utils.getVersion(MApplication.getInstance());
    ...
    public static void post(Context context, String url,
        ...
        if (TextUtils.isEmpty(User.uId) || TextUtils.isEmpty(User.uAccount)) {
            User.uId = MApplication.mSharedPref.getSharePrefString("custid",
                    "");
            User.uAccount = MApplication.mSharedPref.getSharePrefString(
                    "custmobile", "");
        }
        ...
        httpClient.post(MApplication.getInstance(), AppConfig.HOST + url,
