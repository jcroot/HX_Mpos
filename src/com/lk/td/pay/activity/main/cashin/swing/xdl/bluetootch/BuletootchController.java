...
public interface BuletootchController {
	 ...
	 * @throws Exception
	 */
	public void OpenCardReader(Context context, OpenCardType[] cardReaders,CardRule cardRule, final String msg, final long timeout, final TimeUnit timeunit, SimpleTransferListener transferListener) throws Exception;
