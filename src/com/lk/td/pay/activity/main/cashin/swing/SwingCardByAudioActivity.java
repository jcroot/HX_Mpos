...
import com.lk.td.pay.activity.main.cashin.CashInConfirmActivity;
...
//			}
			...
			if(action.equals(ACTION_BUY_DEVICE)){
				Intent buy=new Intent(SwingCardByAudioActivity.this,CashInConfirmActivity.class).setAction(CashInConfirmActivity.ACTION_BUY_DEVICE);
				buy.putExtra("", "");
				startActivity(buy);
				finish();
				return;
		...
		public void onReturnKsn(Hashtable<String, String> ksnTable) {
			...
			if(ACTION_BUY_DEVICE.equals(action)){
				Intent intent = new Intent(SwingCardByAudioActivity.this,CashInConfirmActivity.class).setAction(CashInConfirmActivity.ACTION_BUY_DEVICE);
